...
#per vederlo scrivo il nome dell'oggetto e me lo visualizza nella console
penguins_long
...
ggplot(penguins_long, aes(x = species, y = value, fill = measure)) +
  geom_col(position = "dodge") + #colonne una accanto all'altra'
  labs(
...
#si può mettere anche tutto insieme ma è difficile fare il tracciamento dell'errore
#meglio spezzare i codici
